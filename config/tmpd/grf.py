...
def get_config():
    ...
    # sampling.cs_method = 'diffusionlib2023ajacfwd'
    # sampling.cs_method = 'diffusionlib2023ajacrev'
    # sampling.cs_method = 'diffusionlib2023avjp'
    # sampling.cs_method = 'chung2022scalarplus'
    # sampling.cs_method = 'diffusionlib2023b'
    # sampling.cs_method = 'diffusionlib2023ajacfwd'
    # sampling.cs_method = 'diffusionlib2023bvjpplus'
    # sampling.cs_method = 'diffusionlib2023bjacfwd'
