...
class ConditionalInstanceNorm2dPlus(nn.Module):
    ...
    def __call__(self, x, y):
        ...
        if self.bias:
            ...
            embed = nn.Embed(
                num_embeddings=self.num_classes, features=x.shape[-1] * 3, embedding_init=init_embed
            )
        else:
            ...
            embed = nn.Embed(
                num_embeddings=self.num_classes, features=x.shape[-1] * 2, embedding_init=init_embed
            )
