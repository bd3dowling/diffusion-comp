...
class NCSNv2(nn.Module):
    ...
    def __call__(self, x, labels, train=True):
        ...
        h = ResidualBlock(2 * nf, resample="down", act=act, normalization=normalizer, dilation=2)(
            layer2
        )
        layer3 = ResidualBlock(
            2 * nf, resample=None, act=act, normalization=normalizer, dilation=2
        )(h)
        h = ResidualBlock(2 * nf, resample="down", act=act, normalization=normalizer, dilation=4)(
            layer3
        )
        ...
        ref2 = RefineBlock(layer3.shape[1:3], 2 * nf, interpolation=interpolation, act=act)(
            [layer3, ref1]
        )
        ref3 = RefineBlock(layer2.shape[1:3], 2 * nf, interpolation=interpolation, act=act)(
            [layer2, ref2]
        )
        ref4 = RefineBlock(layer1.shape[1:3], nf, interpolation=interpolation, act=act, end=True)(
            [layer1, ref3]
        )
...
class NCSN(nn.Module):
    ...
    def __call__(self, x, labels, train=True):
        ...
        h = CondResidualBlock(2 * nf, resample="down", act=act, normalization=normalizer)(
            layer1, labels
        )
        layer2 = CondResidualBlock(2 * nf, resample=None, act=act, normalization=normalizer)(
            h, labels
        )
        h = CondResidualBlock(
        ...
        ref2 = CondRefineBlock(
            layer3.shape[1:3], 2 * nf, normalizer=normalizer, interpolation=interpolation, act=act
        )([layer3, ref1], labels)
        ref3 = CondRefineBlock(
            layer2.shape[1:3], 2 * nf, normalizer=normalizer, interpolation=interpolation, act=act
        )([layer2, ref2], labels)
...
class NCSNv2_128(nn.Module):  # pylint: disable=invalid-name
    ...
    def __call__(self, x, labels, train=True):
        ...
        h = ResidualBlock(4 * nf, resample="down", act=act, normalization=normalizer, dilation=2)(
            layer3
        )
        layer4 = ResidualBlock(
            4 * nf, resample=None, act=act, normalization=normalizer, dilation=2
        )(h)
        h = ResidualBlock(4 * nf, resample="down", act=act, normalization=normalizer, dilation=4)(
            layer4
        )
        ...
        ref2 = RefineBlock(layer4.shape[1:3], 2 * nf, interpolation=interpolation, act=act)(
            [layer4, ref1]
        )
        ref3 = RefineBlock(layer3.shape[1:3], 2 * nf, interpolation=interpolation, act=act)(
            [layer3, ref2]
        )
        ref4 = RefineBlock(layer2.shape[1:3], nf, interpolation=interpolation, act=act)(
            [layer2, ref3]
        )
        ref5 = RefineBlock(layer1.shape[1:3], nf, interpolation=interpolation, act=act, end=True)(
            [layer1, ref4]
        )
...
class NCSNv2_256(nn.Module):  # pylint: disable=invalid-name
    ...
    def __call__(self, x, labels, train=True):
        ...
        ref31 = RefineBlock(layer31.shape[1:3], 2 * nf, interpolation=interpolation, act=act)(
            [layer31, ref2]
        )
        ref3 = RefineBlock(layer3.shape[1:3], 2 * nf, interpolation=interpolation, act=act)(
            [layer3, ref31]
